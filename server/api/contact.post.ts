        ...
        <html>
          <head>
            ...
            <style>
              ...
              .icon-circle { width: 48px; height: 48px; background-color: #f3e8ff; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 16px; color: #a855f7; font-size: 24px; }
              .title { font-size: 24px; font-weight: 700; color: #111827; margin: 0 0 8px; letter-spacing: -0.025em; }
              .subtitle { color: #6b7280; font-size: 14px; margin: 0; }
              .section { margin-bottom: 24px; }
              .label { color: #a855f7; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 8px; display: block; }
              .value-box { background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; }
              .user-info { display: flex; align-items: center; gap: 12px; }
              .avatar { width: 36px; height: 36px; background-color: #f3e8ff; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #a855f7; font-weight: 600; font-size: 14px; }
              ...
              .brand-icon { width: 20px; height: 20px; background-color: #a855f7; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-size: 10px; font-weight: bold; }
              ...
              <div class="card">
                ...
                <div class="footer">
                  <div class="brand">
                    ...
                    <span class="brand-name">TIAGO MARTINS PORTFOLIO</span>
                  </div>
                  <p class="copyright">Enviado via Resend API • © ${new Date().getFullYear()} Tiago Martins</p>
                </div>
              </div>
            </div>
          </body>
